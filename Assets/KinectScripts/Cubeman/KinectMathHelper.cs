...
using UnityEngine;
	...
	public class KinectMathHelper: MonoBehaviour
	{
		public static class MathHelpers
		{
			...
			/// </remarks> 
			public static Vector3 QuaternionToEuler(Windows.Kinect.Vector4 q)
			{
			...
			public static CameraSpacePoint QuaternionToEuler3(Windows.Kinect.Vector4 orientation)
			{
			...
			public static Vector3 QuaternionToYawPitchRoll(Windows.Kinect.Vector4 q)
			{
			...
			public static double AngleBetweenPoints(Vector2 p1, Vector2 p2)
			{
				double retval;
